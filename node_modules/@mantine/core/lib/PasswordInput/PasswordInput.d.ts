...
export interface PasswordInputProps extends DefaultProps<PasswordInputStylesNames>, Omit<TextInputProps, 'classNames' | 'styles' | 'rightSection' | 'rightSectionWidth' | 'rightSectionProps'> {
